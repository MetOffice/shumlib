...
FCFLAGS_EXTRA=-O2 -Ovector1 -hfp0 -hflex_mp=strict -hipa1 -hnopgas_runtime -hnocaf -herror_on_warning -hcpu=x86_64 -target-network=none -hnosafe_addr
...
CCFLAGS_EXTRA=-O3 -h c99 -hconform -hstdc -hnotolerant -hnognu -hnopgas_runtime -herror_on_warning -hcpu=x86_64 -target-network=none -hnosafe_addr
# Flag used to set PIC (Position-independent-code; required by dynamic lib 
# and so will only be passed to compile objects destined for the dynamic lib)
CCFLAGS_PIC=-h pic
...
PLATFORM=ncas-xc30-crayftn-craycc
